...
%             end
            ...
            for rho_het = rho_hets
                for rho = rhos
                    ...
                    params{ii}.x0 = [rho - 0.01, rho + 0.01];
%                     rho_diffs = linspace(-rho_het, rho_het, 5);
%                     params{ii}.rho_grid = params{1}.rho + linspace(-2*rho_het, 2*rho_het, 5)';
%                     params{ii}.rho_grid = params{ii}.rho + linspace(-2*rho_het, 2*rho_het, 5)';
                    params{ii}.rho_grid = linspace(-2*rho_het, 2*rho_het, 5)';
                    params{ii}.nb = 250;
                    params{ii}.nb_KFE = 250;
                    params{ii}.na = 2;
                    params{ii}.na_KFE = 2;
                    ...
                    params{ii}.r_b = 0.0025;
                    params{ii}.r_a = params{ii}.r_b;
                    params{ii}.name = sprintf('1A het rho, spacing=%d, rho_cent_start=%d', rho_het, rho);
                end
            end
