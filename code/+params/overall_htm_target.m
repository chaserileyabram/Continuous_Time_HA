...
%         params.calibration_bounds = {rho_bds};
        ...
        median_calibration.calibration_vars = {'rho', 'r_a', 'rebalance_cost'};
...
%                         for kappa1 = kappa_1s
        ...
        %                                 params{ii}.r_a = r_a;
                                    ...
                                    params{ii}.calibration_scales = [100, 100, 100]; % Scales deviation for calibration
